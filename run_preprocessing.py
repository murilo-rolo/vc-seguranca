...
ponto de entrada com subcomandos:
    ...
    index     - Gera índice unificado CSV linkando vídeos com emoções e pose
...
Uso:
    ...
    # Gerar índice unificado
    python run_preprocessing.py index --split all
...
def cmd_index(args):
    """Gera índice unificado CSV que linka vídeos com emoções e pose."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_index = subparsers.add_parser(
        "index",
        help="Gera índice unificado CSV que linka vídeos com emoções e pose",
        description="Gera um CSV unificado que linka cada vídeo com seus arquivos de emoção e pose."
    )
